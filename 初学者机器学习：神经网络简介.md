...
![1560785551167](/home/challow/.config/Typora/typora-user-images/1560785551167.png)

考虑损失的另一种方式是权重和偏差。让我们在网络中标出每个权重和偏见：

![1560785571631](/home/challow/.config/Typora/typora-user-images/1560785571631.png)
...
$$
想象一下，我们想调整一下w1.如果我们改变w1，L会如何变化？这是一个问题，偏导数![1560785713654](/home/challow/.config/Typora/typora-user-images/1560785713654.png)可以回答。我们如何计算呢？

> 这是数学开始变得更复杂的地方。不要气馁！我建议让笔和纸一起跟进 - 它会帮助你理解。

首先，让我们重写一下偏导数![1560785760740](/home/challow/.config/Typora/typora-user-images/1560785760740.png)

![1560785773253](/home/challow/.config/Typora/typora-user-images/1560785773253.png)

> 这是因为链式规则。

我们可以算一算![1560785839450](/home/challow/.config/Typora/typora-user-images/1560785839450.png)因为我们算了![1560785875132](/home/challow/.config/Typora/typora-user-images/1560785875132.png)

![1560785983462](/home/challow/.config/Typora/typora-user-images/1560785983462.png)

现在，让我们弄清楚该怎么做![1560785897969](/home/challow/.config/Typora/typora-user-images/1560785897969.png)就像以前那样让h1，h2，o1成为它们所代表的神经元的输出。然后：

![1560785997352](/home/challow/.config/Typora/typora-user-images/1560785997352.png)

> f是sigmoid激活函数，还记得吗？

由于w1只影响h1（不是h2），我们可以写

![1560786054680](/home/challow/.config/Typora/typora-user-images/1560786054680.png)

我们对![1560786085343](/home/challow/.config/Typora/typora-user-images/1560786085343.png)做同样的事情：

![1560786099329](/home/challow/.config/Typora/typora-user-images/1560786099329.png)

> 你猜到了，链式法则。。

x1这里是重量，x2是高度。这是我们第二次看到f'（x）（sigmoid函数的推导）！让我们推导出来：

![1560786178328](/home/challow/.config/Typora/typora-user-images/1560786178328.png)

我们稍后会将这个漂亮的形式用于f'（x）。

我们完成了！我们设法将![1560786230260](/home/challow/.config/Typora/typora-user-images/1560786230260.png)分解成我们可以计算的几个部分：

![1560786241274](/home/challow/.config/Typora/typora-user-images/1560786241274.png)
...
![1560872675440](/home/challow/.config/Typora/typora-user-images/1560872675440.png)

网络输出y_pred=0.524,不强烈支持男性（0）或女性（1）.我们算一算吧![1560872740444](/home/challow/.config/Typora/typora-user-images/1560872740444.png):

![1560872768635](/home/challow/.config/Typora/typora-user-images/1560872768635.png)
...
![1560872965542](/home/challow/.config/Typora/typora-user-images/1560872965542.png)

η是一个常数，称为**学习率**，控制我们训练的速度。我们所做的就是从w1减去![1560873018590](/home/challow/.config/Typora/typora-user-images/1560873018590.png)

- 如果![1560873076843](/home/challow/.config/Typora/typora-user-images/1560873076843.png)是正的，w1就会减小，随之L也会减小
- 如果![1560873076843](/home/challow/.config/Typora/typora-user-images/1560873076843.png)是负的，w1就会增加，随之L也会减小
...
![1560873280455](/home/challow/.config/Typora/typora-user-images/1560873280455.png)
...
![1560873320410](/home/challow/.config/Typora/typora-user-images/1560873320410.png)
